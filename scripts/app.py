...
from src.app.models.document import DocumentSequence
...
app.template_folder = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'src', 'app', 'templates')
...
# === Blueprint kayıtları ===
from src.app.views.auth import auth_bp
app.register_blueprint(auth_bp)

from src.app.views.document_routes import document_bp
app.register_blueprint(document_bp)

from src.app.views.upload_routes import upload_bp
app.register_blueprint(upload_bp)

from src.app.views.admin_settings_routes import settings_bp
app.register_blueprint(settings_bp)

from src.app.views.users_routes import users_bp
app.register_blueprint(users_bp)

from src.app.views.preview_routes import preview_bp
app.register_blueprint(preview_bp)

from src.app.views.public import public_bp
...
def before_request():
    if not current_user.is_authenticated:
        if request.endpoint:
            ...
            if request.endpoint.startswith("public."):
                return
            ...
            if request.endpoint == "public.index":
                return
            # Only redirect to login for document-related routes
            if request.endpoint.startswith(("documents.", "upload.", "admin.", "users.")):
                return redirect(url_for('auth.login', next=request.url))
        # Don't redirect for any other routes
        return
